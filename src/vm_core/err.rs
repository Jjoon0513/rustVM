...
impl VmErr {
    pub(crate) fn kernel_memory_overflow(data: Vec<u8>) -> Self {
    ...
    pub(crate) fn user_memory_overflow(data: Vec<u8>) -> Self {
    ...
    pub(crate) fn ivt_memory_overflow(data: Vec<u8>) -> Self {
